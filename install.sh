...
do_install() {
  ...
  # Check files exist
  local modules=(ccs-core.sh ccs-health.sh ccs-failure-triage.sh ccs-viewer.sh ccs-handoff.sh ccs-overview.sh ccs-feature.sh ccs-ops.sh ccs-dispatch.sh ccs-review.sh ccs-run.sh ccs-project.sh ccs-dashboard.sh)
